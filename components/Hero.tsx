          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <button 
                ...
                className="flex h-12 items-center justify-center rounded-xl bg-primary px-10 text-base font-medium text-white w-full sm:w-auto"
              >
                Start for free
              </button>
              <button className="flex h-12 items-center justify-center rounded-xl bg-white border border-slate-200 px-10 text-base font-medium text-slate-900 w-full sm:w-auto">
                View Demo
              </button>
            </div>
