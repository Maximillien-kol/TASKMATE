        ...
        <form onSubmit={handleSuggest} className="space-y-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="e.g. need to call my dentist on tuesday for that cleaning appointment"
              className="flex-1 rounded-2xl border-slate-200 focus:border-primary focus:ring-primary h-14 px-5 text-lg"
            />
            <button
              disabled={loading}
              className="bg-primary text-white rounded-2xl px-6 h-14 font-bold flex items-center justify-center disabled:opacity-50"
            >
              {loading ? (
